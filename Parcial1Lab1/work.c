...
int work_load(int id, eWork works[], int sizeWorks, eMoto motorcycles[], int sizeMotorcycles, eType types[], int sizeTypes, eColor colors[], int sizeColors, eService services[], int sizeServices)
{
    eWork auxWork;
    ...
    else
    {
        ...
        else
        {
            ...
            {
                // Tambien pido fecha validada para que figure correctamente después del alta
